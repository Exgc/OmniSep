...
def main():
    ...
    root='/nfs/chengxize.cxz/projects/clipsep/clipsep/data/MUSIC/solo'
...
if __name__ == "__main__":
    ...
    """
    python form_list.py \
        -a /nfs/chengxize.cxz/data/MUSIC/solo/audio \
        -f /nfs/chengxize.cxz/data/MUSIC/solo/frames \
        -o /nfs/chengxize.cxz/projects/clipsep/clipsep/data/MUSIC-v1/solo
